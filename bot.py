...
def contains_inappropriate_language_muted(text: str) -> bool:
    # Pattern to match any variation of "clown" with or without spaces and with possible substitutions
    pattern = re.compile(r"\b[cC][^\w]*[lL1!][^\w]*[oO0][^\w]*[wW][^\w]*[nN]\b", re.IGNORECASE)
